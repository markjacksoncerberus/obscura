...
| `performance-timeline/case-sensitivity.any.html` | 0 | **1/3** | ⬆️ | Quest #20: observer type/entryTypes case-sensitivity subtest passes; the 2 fails need `resource` timeline entries (resource timing — not implemented) |
