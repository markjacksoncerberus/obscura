...
| `dom/nodes/ParentNode-querySelector-All.html` | 1396/1977 | **1917/1977** | ⬆️ | Quest #01: stable `opaque()` (:nth-*/`*-of-type`) + CSS2 pseudo-elements + qs WebIDL coercion + `:lang()` + `:link`/`:any-link` |
