...
pub fn build_extension() -> Extension {
    Extension {
        ...
        ops: std::borrow::Cow::Owned(vec![
            ...
            crate::aes_ops::op_crypto_aes_cbc_encrypt(),
            crate::aes_ops::op_crypto_aes_cbc_decrypt(),
            crate::aes_ops::op_crypto_aes_ctr(),
            crate::aes_ops::op_crypto_aes_gcm_encrypt(),
            crate::aes_ops::op_crypto_aes_gcm_decrypt(),
            crate::aes_ops::op_crypto_aes_kw_wrap(),
            crate::aes_ops::op_crypto_aes_kw_unwrap(),
            crate::compress_ops::op_compress_new(),
            crate::compress_ops::op_compress_push(),
            crate::compress_ops::op_compress_finish(),
            crate::compress_ops::op_compress_errored(),
            crate::compress_ops::op_compress_free(),
            crate::rsa_ops::op_crypto_rsa_generate(),
            crate::rsa_ops::op_crypto_rsa_public(),
            crate::rsa_ops::op_crypto_rsa_modulus_bits(),
            crate::rsa_ops::op_crypto_rsa_sign(),
            crate::rsa_ops::op_crypto_rsa_verify(),
            crate::rsa_ops::op_crypto_rsa_encrypt(),
            crate::rsa_ops::op_crypto_rsa_decrypt(),
            crate::ec_ops::op_crypto_ec_generate(),
            crate::ec_ops::op_crypto_ec_public(),
            crate::ec_ops::op_crypto_ec_point_normalize(),
            crate::ec_ops::op_crypto_ecdsa_sign(),
            crate::ec_ops::op_crypto_ecdsa_verify(),
            crate::ec_ops::op_crypto_ecdh(),
            crate::ec_ops::op_crypto_ed25519_generate(),
            crate::ec_ops::op_crypto_ed25519_public(),
            crate::ec_ops::op_crypto_ed25519_sign(),
            crate::ec_ops::op_crypto_ed25519_verify(),
            crate::ec_ops::op_crypto_x25519_generate(),
            crate::ec_ops::op_crypto_x25519_public(),
            crate::ec_ops::op_crypto_x25519(),
        ]),
        ..Default::default()
    }
}
